...
Tr = T/Tc;
alpha = (1+(0.37464+1.54225*omega-0.26992*omega^2)*(1-sqrt(Tr)))^2;
...
title('Displacement (PR)vs. Time Elapsed');
grid on; 
...
xlabel('Time Elapsed [s]');
ylabel('Velocity [m/s]');
title('Velocity (PR)vs. Time Elapsed');
grid on; 
...
title('Acceleration (PR) vs. Time Elapsed');
grid on; 
...
xlabel('Time Elapsed [s]');
ylabel('Volume [m^3]');
title('Gas Volume (PR) vs. Time Elapsed');
grid on; 
...
xlabel('Time Elapsed [s]');
ylabel('Pressure [Pa]');
title('Gas Pressure (PR) vs. Time Elapsed');
grid on; 
...
xlabel('Time Elapsed [s]');
ylabel('Work [J]');
title('Gravity Work (PR) vs. Time Elapsed');
grid on; 
...
xlabel('Time Elapsed [s]');
ylabel('Work [J]');
title('Atmospheric Work (PR) vs. Time Elapsed');
grid on; 
...
xlabel('Time Elapsed [s]');
ylabel('Work [J]');
title('Friction Work (PR) vs. Time Elapsed');
grid on; 
...
xlabel('Time Elapsed [s]');
ylabel('Work [J]');
title('Gas Work (PR) vs. Time Elapsed');
grid on; 
...
title('Total Work & KE (PR) vs. Time Elapsed');

[M1_PR, x_real_PR, W_gas_PR] = Quasi_work(phi, Omega, sig, eps, alpha);

figure;
plot(x_real_PR, W_gas_PR);
xlabel('Displacement (m)');
ylabel('Work (J)');
title('Quasi Static Work (PR) vs Displacement');
grid on;
