...
Tr = T/Tc;
alpha = (1+(0.48+1.574*omega-0.176*omega^2)*(1-sqrt(Tr)))^2;
...
title('Displacement (SRK) vs. Time Elapsed');
grid on; 
...
xlabel('Time Elapsed [s]');
ylabel('Velocity [m/s]');
title('Velocity (SRK) vs. Time Elapsed');
grid on; 
...
title('Acceleration (SRK) vs. Time Elapsed');
grid on; 
...
xlabel('Time Elapsed [s]');
ylabel('Volume [m^3]');
title('Gas Volume (SRK) vs. Time Elapsed');
grid on; 
...
xlabel('Time Elapsed [s]');
ylabel('Pressure [Pa]');
title('Gas Pressure (SRK) vs. Time Elapsed');
grid on; 
...
xlabel('Time Elapsed [s]');
ylabel('Work [J]');
title('Gravity Work (SRK) vs. Time Elapsed');
grid on; 
...
xlabel('Time Elapsed [s]');
ylabel('Work [J]');
title('Atmospheric Work (SRK) vs. Time Elapsed');
grid on; 
...
xlabel('Time Elapsed [s]');
ylabel('Work [J]');
title('Friction Work (SRK) vs. Time Elapsed');
grid on; 
...
xlabel('Time Elapsed [s]');
ylabel('Work [J]');
title('Gas Work (SRK) vs. Time Elapsed');
grid on; 
...
title('Total Work & KE (SRK) vs. Time Elapsed');

[M1_SRK, x_real_SRK, W_gas_SRK] = Quasi_work(phi, Omega, sig, eps, alpha);

figure;
plot(x_real_SRK, W_gas_SRK);
xlabel('Displacement (m)');
ylabel('Work (J)');
title('Quasi Static Work (SRK) vs Displacement');
grid on;